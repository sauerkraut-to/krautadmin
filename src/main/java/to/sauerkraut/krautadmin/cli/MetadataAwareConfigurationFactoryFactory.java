 ...
 */
public class MetadataAwareConfigurationFactoryFactory<T> implements ConfigurationFactoryFactory<T> {
    @Override
    public ConfigurationFactory<T> create(final Class<T> klass, final Validator validator,
        ...
        return new MetadataAwareConfigurationFactory<>(klass, validator, objectMapper, propertyPrefix);
    }
}
